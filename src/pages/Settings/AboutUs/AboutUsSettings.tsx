...
export default function AboutUsSettings() {
  ...
  return (
    <motion.div
      ...
      className="-mx-6 -mt-6 mb-0 min-h-[calc(100vh-5rem)] bg-background px-6 pb-10 pt-6 lg:-mx-8 lg:px-8"
    >
      <div className="mx-auto max-w-6xl space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
          <SearchInput
            ...
            inputClassName="rounded-lg border-border bg-background text-accent placeholder:text-muted-foreground shadow-sm"
          />
          <Select
            value={dateFilter}
                ...
                <div className="flex shrink-0 flex-col items-center justify-center gap-3 sm:flex-row">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button
                        type="button"
                        className="flex h-9 w-9 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-muted/40 hover:text-accent"
                    ...
                    <TooltipContent
                      side="left"
                      className="max-w-xs border-border bg-card text-left text-accent shadow-md"
                    >
                  ...
                  {canManage && (
                    <button
                      ...
                      className={cn(
                        'flex h-9 w-9 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-muted/40 hover:text-accent'
                      )}
          ...
          <div className="grid gap-4 py-2">
            <div className="grid gap-2">
              ...
              <Input
                ...
                className="rounded-lg border-border bg-background text-accent placeholder:text-muted-foreground"
              />
            </div>
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                rows={6}
                className="resize-y rounded-lg border-border bg-background text-accent placeholder:text-muted-foreground text-sm"
              />
            </div>
          </div>
          <DialogFooter>
