    ...
    >
      <dl className="grid gap-3 text-sm sm:grid-cols-2">
        <div>
          ...
          <dd className="font-medium text-accent">{entry.clinicName}</dd>
        </div>
        <div>
          <dt className="text-muted-foreground">Join date</dt>
          <dd className="font-medium text-accent">{formatDoctorJoinDate(entry.joinDate)}</dd>
        </div>
        <div>
          <dt className="text-muted-foreground">Branch</dt>
          <dd className="font-medium text-accent">{entry.branch}</dd>
        </div>
        <div>
          <dt className="text-muted-foreground">Designation</dt>
          <dd className="font-medium text-accent">{entry.designation}</dd>
        </div>
        <div>
